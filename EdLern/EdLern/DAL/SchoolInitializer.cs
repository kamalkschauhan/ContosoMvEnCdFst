...
namespace EdLern.DAL
{
    public class SchoolInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<SchoolContext>
    {
        protected override void Seed(SchoolContext context)
        {
            ...
            {
                new Consultation{ID=1,ConsultationName="Indoor activities",ConsultationDescription="Indoor activities",IsActive=true},
                new Consultation{ID=2,ConsultationName="Microeconomics",ConsultationDescription="Microeconomics",IsActive=true},
                new Consultation{ID=3,ConsultationName="Macroeconomics",ConsultationDescription="Macroeconomics",IsActive=true},
                new Consultation{ID=4,ConsultationName="Calculus",ConsultationDescription="Calculus",IsActive=true},
                new Consultation{ID=5,ConsultationName="Trigonometry",ConsultationDescription="Trigonometry",IsActive=true},
                new Consultation{ID=6,ConsultationName="Composition",ConsultationDescription="Composition",IsActive=true},
                new Consultation{ID=7,ConsultationName="Art",ConsultationDescription="Art",IsActive=true},
                new Consultation{ID=8,ConsultationName="Music",ConsultationDescription="Music",IsActive=true},
                new Consultation{ID=9,ConsultationName="Social studies",ConsultationDescription="Social studies",IsActive=true},
                new Consultation{ID=10,ConsultationName="Civics and government",ConsultationDescription="Civics and government",IsActive=true},
                new Consultation{ID=11,ConsultationName="History",ConsultationDescription="History",IsActive=true},
                new Consultation{ID=12,ConsultationName="Geography",ConsultationDescription="Geography",IsActive=true},
                new Consultation{ID=13,ConsultationName="English",ConsultationDescription="English",IsActive=true},
                new Consultation{ID=14,ConsultationName="Mathematics",ConsultationDescription="Mathematics",IsActive=true},
                new Consultation{ID=15,ConsultationName="Science",ConsultationDescription="Science",IsActive=true},
                new Consultation{ID=16,ConsultationName="Accounting",ConsultationDescription="Accounting",IsActive=true},
                new Consultation{ID=17,ConsultationName="Business",ConsultationDescription="Business",IsActive=true},
            };
            consultations.ForEach(s => context.Consultations.Add(s));
            context.SaveChanges();
        }
    }
}